...
<html>
  <head>
    ...
    @vite(['resources/scripts/template.js'])
  ...
  <body>
    <div id="div_corpo_template" class="conteiner-xxxl bg-light rounded-4">
      <div id="div_cabecalho_template">
        <h1 id="h1_titulo_do_sistema_template" class="text-center">
          <span>{{$nome_do_sistema_template}}</span>
        </h1>
        <nav id="nav_menu_do_sistema_template">
          <div id="div_opcoes_do_menu_do_sistema_template" class="d-flex justify-content-center">
      ...
      <div id="div_rodape_template">
        <div id="div_informacoes_do_rodape_template" class="row g-0 align-items-center">
          <div id="div_informacoes_do_sistema_template" class="col">
            <div id="div_autor_do_sistema_template" class="text-center">
              <span>Este sistema foi feito por Rodrigo Diniz da Silva.</span>
            </div>
            <div id="div_tecnologias_do_sistema_template" class="text-center">
              <span>Este sistema usa PHP, Laravel, Javascript e Bootstrap.</span>
            </div>
          </div>
        </div>
      </div>
