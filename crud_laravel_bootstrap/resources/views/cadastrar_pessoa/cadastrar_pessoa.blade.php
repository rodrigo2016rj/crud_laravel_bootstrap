...
@vite(['resources/scripts/cadastrar_pessoa.js'])
...
<div id="div_pagina_cadastrar_pessoa">
  ...
  <form id="form_cadastrar" method="post" action="/cadastrar_pessoa/cadastrar">
    ...
    <div id="div_botao_cadastrar" class="parte_do_formulario text-center">
      @csrf
      <input type="submit" id="botao_cadastrar" class="btn botao_basico btn-sm" value="Cadastrar"/>
    </div>
  </form>
